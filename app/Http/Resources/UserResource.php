...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'role' => $this->role,
            'status' => $this->status,
            'address' => $request->user()?->id === $this->id ? $this->address : null,
            'birth_date' => $request->user()?->id === $this->id ? $this->birth_date?->format('Y-m-d') : null,
            'university' => $this->university,
            'department' => $this->department,
            'class_year' => $this->class_year,
            'hometown' => $this->hometown,
            'tc_verified' => (bool) $this->tc_verified,
            'yok_verified' => (bool) $this->yok_verified,
            // İlişkiler
